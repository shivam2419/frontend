...
const ScrapCollectorOrders = () => {
  const backendUrl = "https://scrapbridge-api.onrender.com/api/";
    const profileImg = "ttps://scrapbridge-api.onrender.com" + localStorage.getItem("user_profile");
    const user = {
    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            try {
                const response = await fetch(`${backendUrl}order-details/${localStorage.getItem("user_id")}/`, {
                    method: "GET",
                    headers: {
