...
export const Navbar = () => {
    ...
    if(profileImage) {
        profileImage = "https://scrapbridge-api.onrender.com"+localStorage.getItem('user_profile');
    } else {
    ...
    return (
        <div>
            <div id="mySidebar" className="sidebar">
                ...
                <Link to="https://huggingface.co/spaces/shivam2419/scrap-classification">Classify-Image</Link>
                {isAuthenticated && (
                    <>
            ...
            <div className="main-content">
                <nav>
                    ...
                    <ul className="navbar-links">
                        ...
                        <li><Link to="https://huggingface.co/spaces/shivam2419/scrap-classification">Classify-Image</Link></li>
                    </ul>
